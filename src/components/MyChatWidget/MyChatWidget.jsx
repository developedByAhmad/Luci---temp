      ...
      <div className="chat">
        ...
        <input type="file" name="chat-img" id="chat-img" accept=".png,.jpg,.jpeg" onChange={(e)=>setFilename(e.target.files[0].name)}/>
          <div
            ...
            disabled="true"
          ></div>
          <button id="sendMessage"><FiSend /></button>
        </div>
        {(filename !== "") && (
        <div className="d-flex justify-content-start align-items-center px-3" style={{backgroundColor: "#eee", color: "#000", marginTop: "-10px"}}>
